	...
	OtherSuspendSaveUnit.size = 0x3C
...
PackOtherSuspendSaveUnit:
	...
	ldrb r1, [ r1 ]
	ldrb r1, [r4, r1]	 @ r1 = u->stairbyte
	strb r1, [r2, #0x0C]	 @ su->stairasmbyte = u->stairbyte
	
	ldr r1, =CharacterStructFatigueByte
	ldrb r1, [ r1 ]
	ldrb r1, [r4, r1]	 @ r1 = u->fatiguebyte
	strb r1, [r2, #0x0D]	 @ su->fatiguebyte = u->fatiguebyte
...
UnpackOtherSuspendSaveUnit:
	...
	ldr r3, =CharacterStructStairByte
	ldrb r3, [ r3 ]
	ldrb r1, [r2, #0x0C]	 @ r1 = su->stairasmbyte
	strb r1, [r0, r3]	 @ u->stairbyte = su->stairasmbyte
	
	ldr r3, =CharacterStructFatigueByte
	ldrb r3, [ r3 ]
	ldrb r1, [r2, #0x0D]	 @ r1 = su->fatiguebyte
	strb r1, [r0, r3]	 @ u->fatiguebyte = su->fatiguebyte
