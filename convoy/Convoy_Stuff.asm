...
.set Get_Partition_From_Chapter_Data_Table, 0		@ change this to 0 if you want to do a linked list with functions instead (otherwise it uses the byte at +0x3D in the chapter data table as the partition ID
