...
.global ESU_SaveStore
.type ESU_SaveStore, %function
ESU_SaveStore: @ r0 = Sram target address, r1 = size.
...
.global ESU_LoadStore
.type ESU_LoadStore, %function
ESU_LoadStore: @ r0 = Sram source address, r1 = size.
push { r4, r5, lr }
mov r4, r0
mov r5, r1
ldr r0,=#0x020282F0
