...
.global ESU_SaveParents
.type ESU_SaveParents, %function
ESU_SaveParents: @ r0 = Sram target address, r1 = size.
...
.global ESU_LoadParents
.type ESU_LoadParents, %function
ESU_LoadParents: @ r0 = Sram source address, r1 = size.
push { r4, r5, lr }
mov r4, r0
mov r5, r1
ldr r0,=#0x020284F0
