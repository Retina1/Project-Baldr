...
.global ESU_SaveChapters
.type ESU_SaveChapters, %function
ESU_SaveChapters: @ r0 = Sram target address, r1 = size.
...
.global ESU_LoadChapters
.type ESU_LoadChapters, %function
ESU_LoadChapters: @ r0 = Sram source address, r1 = size.
push { r4, r5, lr }
mov r4, r0
mov r5, r1
ldr r0,=#0x02028548
...
.global ClearChapters
.type ClearChapters, %function
ClearChapters: 
